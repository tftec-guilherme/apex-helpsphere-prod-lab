...
const router = createHashRouter([
    {
        ...
        children: [
            ...
            {
                // Lab Avançado v0.4.0: criação de ticket via form dedicado.
                // Rota antes de ":ticketId" para evitar match de "new" como ID numérico.
                path: "tickets/new",
                lazy: () => import("./pages/tickets/NewTicket")
            },
            {
